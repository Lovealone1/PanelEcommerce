<template>
                      ...
                      <div class="col-12 col-lg-10 col-xl-8">
                          ...
                          <div class="row">
                              ...
                              <div class="form-group">
                                  ...
                                  <small class="form-text text-muted">
                                      Seleccion de variacion.
                                  </small>
                                   <select class="form-select mb-3" v-model="detalle.variedad">
                                      <option value="" selected disabled>Seleccionar</option>
                                      <option :value="item._id" v-for="item in variedades">{{item.variacion.toUpperCase()}} - {{item.sku}} - {{item.stock}}</option>
                                  </select>
  ...
  export default {
    ...
    methods: {
        ...
        init_productos(){
            this.productos = [];
            axios.get(this.$url+'/listar_productos_activos',{
                headers:{
        ...
        registro_ingreso(){
            if(!this.ingreso.proveedor){
                 ...
                 this.$notify({
                      group: 'foo',
                      title: 'ERROR',
                      text: 'Seleccione el monto total',
                      type: 'error'
                  });
                 ...
                 this.$notify({
                      group: 'foo',
                      title: 'ERROR',
                      text: 'Suba la factura de compra',
                      type: 'error'
                  });
            }else{
                ...
                fm.append('monto_resultado',this.total);
