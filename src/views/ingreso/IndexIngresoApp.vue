                            ...
                            <div class="col-12 col-lg-10 col-xl-8">
                                ...
                                <div class="col">
                                    ...
                                    <h1 class="header-title">
                                        <b>Todas los ingresos de productos</b>
                                    </h1>
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody class="fs-base" v-if="ingresos.length >= 1">
                                    <tr v-for="item in ingresos">
                                        ...
                                        <td>
                                            <a>#{{item.serie.toString().padStart(4,'0000')}}</a>
                                        </td>
                                        <td>
                                            {{convertCurrency(item.monto_resultado)}}
                                        </td>
                                        <td>
                                            <a :href="$url+'/obtener_comprobante_ingreso/'+item.documento" target="_blank">
                                                <span class="badge bg-success">Ver factura</span>
                                            </a>
                                        </td>
                                        <td>
                                            <button class="btn btn-primary btn-sm" ><router-link style="color: #ffffff !important;" :to="{name: 'ingreso-detalle', params: {id: item._id}}">Ver detalles</router-link></button>
