                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="row">
                                                            <div class="col text-center">
                                                                ...
                                                                <b-modal centered :id="'delete-'+item._id" title="BootstrapVue" title-html="<h4 class='card-header-title'><b>Eliminar imagen</b></h4>" 
            ...
            axios.delete(this.$url+'/eliminar_galeria_producto_admin/'+id,{
                ...
                if (result.data.message) {
                    ...
                    this.$notify({
                        group: 'foo',
                        title: 'SUCCESS',
                        text: 'Se eliminó la imagen correctamente',
                        type: 'success'
                    });
                this.init_galeria();
                }
