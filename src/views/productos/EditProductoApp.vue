...
<!-- Last name -->
                                        ...
                                        <!-- Input -->
                                        <input type="text" class="form-control" placeholder="Título de la variacion" v-model="producto.str_variedad">
                                        ...
                                        <div class="col-12 col-md-12">
                                            ...
                                            <!-- Input -->
                                            <textarea class="form-control" id=""  rows="3" placeholder="Descripcion del producto..." v-model="producto.descripcion"></textarea>
                                        ...
                                        <!-- Button -->
                                        <button class="btn btn-primary mt-4" v-on:click="validar()">
                                        Actualizar producto
                                        </button>
                                        <!-- Divider -->
                                        <hr class="mt-4 mb-5">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <input type="text" class="form-control" placeholder="Tallas, colores..." v-model="variedad.variacion">
                                            </div>
                                            <div class="col">
                                                    <small class="text-muted">
                                                    Acción*
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="list-group-item" v-for="item in variaciones">
                                                    <div class="row align-items-center" >

                                                    <div class="col-auto">
                                                        <!-- Heading -->
                                                        <h4 class="mb-0">
                                                        {{item.variacion.toUpperCase()}}
                                                        </h4>
    ...
    methods:{
        ...
        validar(){
            if(!this.producto.titulo){
                ...
                this.$notify({
                    group: 'foo',
                    title: 'ERROR',
                    text: 'Seleccione la subcategoría del producto',
                    type: 'error'
                });
        ...
        actualiar(){
            ...
            if (this.portada != undefined) {
                ...
                data.append('categoria',this.producto.subcategoria);
        ...
        validar_variedad(){
            ...
            }else if(!this.variedad.variacion){
                this.$notify({
                    group: 'foo',
                    title: 'ERROR',
                    text: 'Ingrese la variacion del producto',
                    type: 'error'
                });
            }else{
        ...
        registro_variacion(){
            axios.post(this.$url+'/registro_variacion_producto',this.variedad,{
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': this.$store.state.token,
                }
                ...
                this.$notify({
                    group: 'foo',
                    title: 'SUCCESS',
                    text: 'Se agregó la variación correctamente',
                    type: 'success'
                });
        ...
        eliminar(id){
            axios.delete(this.$url+'/eliminar_variedad_producto/'+id,{
                ...
                if (result.data.message) {
                    ...
                    group: 'foo',
                    title: 'SUCCESS',
                    text: 'Se eliminó la variación correctamente',
                    type: 'success'
                    });
                    this.init_variedades();
                }
